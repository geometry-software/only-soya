...
import { CustomerConstants, CustomerConstantsCategoryLabel } from '../utils/customer.constants'

const storeFeatureKey: string = CustomerConstants.storeFeatureKey
const paginationTitle: string = CustomerConstants.paginationTitle
const paginationSize: Array<number> = CustomerConstants.paginationSize
